/**************************************************************************
 ...
 Description:  Autocall macro to create ind_2017f format with 2017
 Ipums industry codes. 

 Modifications:
**************************************************************************/

/** Macro Fmt_ind_2017f - Start Definition **/

%macro Fmt_ind_2017f( lib=work, fmt=ind_2017f );
