/**************************************************************************
 ...
 Description:  Autocall macro to create occ_2018f format with 2018
 Ipums occupation codes. 
 
 Source: Box\Greater DC\Libraries\Ipums\IPUMS USA _ 2018 Occupation Codes.xlsx

 Modifications:
**************************************************************************/

/** Macro Fmt_occ_2018f - Start Definition **/

%macro Fmt_occ_2018f( lib=work, fmt=occ_2018f );
